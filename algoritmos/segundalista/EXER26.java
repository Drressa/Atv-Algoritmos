...
public class EXER26 {
    public static void main(String[] args) {
        ...
        String primeiroColocado, segundoColocado, terceiroColocado, stPontosPrimeiro,
                stPontosSegundo, stPontosTerceiro;
        double premio1, premio2, premio3;


        //entrada de dados
        primeiroColocado = JOptionPane.showInputDialog(null, "Nome do primeiro colocado:");
        stPontosPrimeiro = JOptionPane.showInputDialog(null, "Informe a quantidade de pontos do" +
                " primeiro colocado:");
        segundoColocado = JOptionPane.showInputDialog(null, "Nome do segundo colocado:");
        stPontosSegundo = JOptionPane.showInputDialog(null, "Informe a quantidade de pontos do" +
                " segundo colocado:");
        terceiroColocado = JOptionPane.showInputDialog(null, "Nome do terceiro colocado:");
        stPontosTerceiro = JOptionPane.showInputDialog(null, "Informe a quantidade de pontos do" +
                " terceiro colocado:");
