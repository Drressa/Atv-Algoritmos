...
public class Questao1 {
    public static void main(String[] args) {
        ...
        double comprimento = Double.parseDouble(JOptionPane.showInputDialog("Qual o comprimento do terreno:"));
            double largura = Double.parseDouble(JOptionPane.showInputDialog("Qual a largura do terreno:"));
